...
mboxFactory.prototype.setVisitorIdParameters =  function(_url, _mboxName) {
  var imsOrgId = 'B1441C8B533095C00A490D4D@AdobeOrg';
...
if (typeof mboxVersion == 'undefined') {
  ...
  var mboxFactoryDefault = new mboxFactory('themathworksinc.tt.omtrdc.net', 'themathworksinc',
    'default');
};
...
if (mboxGetPageParameter("mboxDebug") != null ||
  ...
  document.write('<' + 'scr' + 'ipt language="Javascript1.2" src='
    + '"//admin10.testandtarget.omniture.com/admin/mbox/mbox_debug.jsp?mboxServerHost=themathworksinc.tt.omtrdc.net'
    + '&clientCode=themathworksinc"><' + '\/scr' + 'ipt>');
};
...
function mboxLoadSCPlugin(_siteCatalystCore) {
  ...
  _siteCatalystCore.m_tt = function(_siteCatalystCore) {
    ...
    _plugin._clientCode = 'themathworksinc';
...
mboxVizTargetUrl = function(_mboxName /*, ... */) {
  ...
  _urlBuilder.setBasePath('/m2/' + 'themathworksinc' + '/viztarget');
